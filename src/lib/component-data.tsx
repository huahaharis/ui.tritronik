...
export function LabelDemo() {
  ...
  pagination: {
    ...
    installation: {
      ...
      manual: "Copy the pagination component from the components library.",
    },
    demo: "pagination",
    usage: [
      `import {
...
export function TableDemo() {
  ...
  masonry: {
    title: "Masonry",
    description: "A responsive masonry layout component.",
    installation: {
      tabs: [{ label: "CLI", active: true }],
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      `// 2. Use the notification utility
...
export function NotificationDemo() {
  ...
  form: {
    title: "Form",
    description:
      "A hook that integrates react-hook-form with useCRUD for seamless form management.",
    demo: "form",
    usage: [
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.onFinish} className="space-y-6">
        ...
        />
        <Button type="submit" {...form.saveButtonProps}>Create Event</Button>
      </form>
    </Form>
  );
}
